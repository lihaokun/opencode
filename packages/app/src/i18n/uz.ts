export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agent",
  "settings.permissions.tool.agent.description": "Sub-agentlarni ishga tushiring",
  "settings.permissions.tool.agent_list.title": "Agentlarni ro'yxatlash",
  "settings.permissions.tool.agent_list.description": "Ushbu seansdagi agentlarni ro'yxatlash",
  "settings.permissions.tool.agent_send.title": "Agentga xabar yuborish",
  "settings.permissions.tool.agent_send.description": "Boshqa agentga xabar yuborish",
  "settings.permissions.tool.agent_stop.title": "Agentni to'xtatish",
  "settings.permissions.tool.agent_stop.description": "Sub-agentni va uning ostidagi agentlarni to'xtatish",
