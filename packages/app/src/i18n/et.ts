export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Käivitage allagendid",
  "settings.permissions.tool.agent_list.title": "Loetle agendid",
  "settings.permissions.tool.agent_list.description": "Loetle selle seansi agendid",
  "settings.permissions.tool.agent_send.title": "Saada agendile sõnum",
  "settings.permissions.tool.agent_send.description": "Saada sõnum teisele agendile",
  "settings.permissions.tool.agent_stop.title": "Peata agent",
  "settings.permissions.tool.agent_stop.description": "Peata allagent ja temast allpool olevad agendid",
