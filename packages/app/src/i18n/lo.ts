export const dict = {
  ...
  "settings.permissions.tool.agent.title": "ຕົວແທນ",
  "settings.permissions.tool.agent.description": "ເປີດຕົວຕົວແທນຍ່ອຍ",
  "settings.permissions.tool.agent_list.title": "ລາຍຊື່ຕົວແທນ",
  "settings.permissions.tool.agent_list.description": "ລາຍຊື່ຕົວແທນໃນເຊສຊັນນີ້",
  "settings.permissions.tool.agent_send.title": "ສົ່ງຂໍ້ຄວາມຫາຕົວແທນ",
  "settings.permissions.tool.agent_send.description": "ສົ່ງຂໍ້ຄວາມຫາຕົວແທນອື່ນ",
  "settings.permissions.tool.agent_stop.title": "ຢຸດຕົວແທນ",
  "settings.permissions.tool.agent_stop.description": "ຢຸດຕົວແທນຍ່ອຍ ແລະ ຕົວແທນທີ່ຢູ່ລຸ່ມມັນ",
