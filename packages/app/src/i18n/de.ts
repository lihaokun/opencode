...
export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Unteragenten starten",
  "settings.permissions.tool.agent_list.title": "Agenten auflisten",
  "settings.permissions.tool.agent_list.description": "Die Agenten dieser Sitzung auflisten",
  "settings.permissions.tool.agent_send.title": "Agent benachrichtigen",
  "settings.permissions.tool.agent_send.description": "Eine Nachricht an einen anderen Agenten senden",
  "settings.permissions.tool.agent_stop.title": "Agent stoppen",
  "settings.permissions.tool.agent_stop.description": "Einen Unteragenten und die Agenten darunter stoppen",
