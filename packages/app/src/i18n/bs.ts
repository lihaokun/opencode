export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Pokretanje pod-agenta",
  "settings.permissions.tool.agent_list.title": "Prikaz agenata",
  "settings.permissions.tool.agent_list.description": "Prikaz agenata u ovoj sesiji",
  "settings.permissions.tool.agent_send.title": "Poruka agentu",
  "settings.permissions.tool.agent_send.description": "Slanje poruke drugom agentu",
  "settings.permissions.tool.agent_stop.title": "Zaustavljanje agenta",
  "settings.permissions.tool.agent_stop.description": "Zaustavljanje pod-agenta i agenata ispod njega",
