export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agentur",
  "settings.permissions.tool.agent.description": "Sjóset undiragentar",
  "settings.permissions.tool.agent_list.title": "Vís agentar",
  "settings.permissions.tool.agent_list.description": "Vís agentarnar í hesari setuni",
  "settings.permissions.tool.agent_send.title": "Send boð til ein agent",
  "settings.permissions.tool.agent_send.description": "Send boð til ein annan agent",
  "settings.permissions.tool.agent_stop.title": "Steðga einum agenti",
  "settings.permissions.tool.agent_stop.description": "Steðga einum undiragenti og agentunum undir honum",
