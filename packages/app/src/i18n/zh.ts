...
export const dict = {
  ...
  "settings.permissions.tool.agent.title": "智能体",
  "settings.permissions.tool.agent.description": "启动子智能体",
  "settings.permissions.tool.agent_list.title": "列出智能体",
  "settings.permissions.tool.agent_list.description": "列出本会话中的智能体",
  "settings.permissions.tool.agent_send.title": "向智能体发消息",
  "settings.permissions.tool.agent_send.description": "向另一个智能体发送消息",
  "settings.permissions.tool.agent_stop.title": "停止智能体",
  "settings.permissions.tool.agent_stop.description": "停止一个子智能体及其下属智能体",
