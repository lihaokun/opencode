export const dict = {
  ...
  "settings.permissions.tool.agent.description": "ذیلی ایجنٹ شروع کرو",
  "settings.permissions.tool.agent_list.title": "ایجنٹس دی لسٹ",
  "settings.permissions.tool.agent_list.description": "ایس سیشن دے ایجنٹس دی لسٹ",
  "settings.permissions.tool.agent_send.title": "ایجنٹ نوں پیغام",
  "settings.permissions.tool.agent_send.description": "کسے ہور ایجنٹ نوں پیغام بھیجو",
  "settings.permissions.tool.agent_stop.title": "ایجنٹ روکو",
  "settings.permissions.tool.agent_stop.description": "ذیلی ایجنٹ تے اوہدے تھلے دے ایجنٹ روکو",
