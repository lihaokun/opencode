export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Запуск субагентов",
  "settings.permissions.tool.agent_list.title": "Список агентов",
  "settings.permissions.tool.agent_list.description": "Список агентов в этой сессии",
  "settings.permissions.tool.agent_send.title": "Сообщение агенту",
  "settings.permissions.tool.agent_send.description": "Отправка сообщения другому агенту",
  "settings.permissions.tool.agent_stop.title": "Остановка агента",
  "settings.permissions.tool.agent_stop.description": "Остановка субагента и подчинённых ему агентов",
