export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Starta underagenter",
  "settings.permissions.tool.agent_list.title": "Lista agenter",
  "settings.permissions.tool.agent_list.description": "Lista agenterna i den här sessionen",
  "settings.permissions.tool.agent_send.title": "Skicka meddelande till agent",
  "settings.permissions.tool.agent_send.description": "Skicka ett meddelande till en annan agent",
  "settings.permissions.tool.agent_stop.title": "Stoppa agent",
  "settings.permissions.tool.agent_stop.description": "Stoppa en underagent och agenterna under den",
