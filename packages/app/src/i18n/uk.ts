export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Запуск підагентів",
  "settings.permissions.tool.agent_list.title": "Список агентів",
  "settings.permissions.tool.agent_list.description": "Список агентів у цій сесії",
  "settings.permissions.tool.agent_send.title": "Повідомлення агенту",
  "settings.permissions.tool.agent_send.description": "Надсилання повідомлення іншому агенту",
  "settings.permissions.tool.agent_stop.title": "Зупинка агента",
  "settings.permissions.tool.agent_stop.description": "Зупинка підагента та підпорядкованих йому агентів",
