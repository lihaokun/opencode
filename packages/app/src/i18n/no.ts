...
export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Start underagenter",
  "settings.permissions.tool.agent_list.title": "Vis agenter",
  "settings.permissions.tool.agent_list.description": "Vis agentene i denne økten",
  "settings.permissions.tool.agent_send.title": "Send melding til agent",
  "settings.permissions.tool.agent_send.description": "Send en melding til en annen agent",
  "settings.permissions.tool.agent_stop.title": "Stopp agent",
  "settings.permissions.tool.agent_stop.description": "Stopp en underagent og agentene under den",
