export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Zagon pod-agentov",
  "settings.permissions.tool.agent_list.title": "Prikaz agentov",
  "settings.permissions.tool.agent_list.description": "Prikaz agentov v tej seji",
  "settings.permissions.tool.agent_send.title": "Sporočilo agentu",
  "settings.permissions.tool.agent_send.description": "Pošiljanje sporočila drugemu agentu",
  "settings.permissions.tool.agent_stop.title": "Zaustavitev agenta",
  "settings.permissions.tool.agent_stop.description": "Zaustavitev pod-agenta in agentov pod njim",
