export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Стартиране на подагенти",
  "settings.permissions.tool.agent_list.title": "Списък с агенти",
  "settings.permissions.tool.agent_list.description": "Списък на агентите в тази сесия",
  "settings.permissions.tool.agent_send.title": "Съобщение до агент",
  "settings.permissions.tool.agent_send.description": "Изпращане на съобщение до друг агент",
  "settings.permissions.tool.agent_stop.title": "Спиране на агент",
  "settings.permissions.tool.agent_stop.description": "Спиране на подагент и агентите под него",
