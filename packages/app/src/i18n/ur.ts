export const dict = {
  ...
  "settings.permissions.tool.agent.title": "ایجنٹ",
  "settings.permissions.tool.agent.description": "ذیلی ایجنٹس چلائیں۔",
  "settings.permissions.tool.agent_list.title": "ایجنٹس کی فہرست",
  "settings.permissions.tool.agent_list.description": "اس سیشن کے ایجنٹس کی فہرست",
  "settings.permissions.tool.agent_send.title": "ایجنٹ کو پیغام بھیجیں۔",
  "settings.permissions.tool.agent_send.description": "کسی دوسرے ایجنٹ کو پیغام بھیجیں۔",
  "settings.permissions.tool.agent_stop.title": "ایجنٹ روکیں۔",
  "settings.permissions.tool.agent_stop.description": "ذیلی ایجنٹ اور اس کے ماتحت ایجنٹس روکیں۔",
