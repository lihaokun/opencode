export const dict = {
  ...
  "settings.permissions.tool.agent.title": "აგენტი",
  "settings.permissions.tool.agent.description": "ქვე-აგენტების გაშვება",
  "settings.permissions.tool.agent_list.title": "აგენტების ჩამონათვალი",
  "settings.permissions.tool.agent_list.description": "ამ სესიის აგენტების ჩამონათვალი",
  "settings.permissions.tool.agent_send.title": "შეტყობინება აგენტს",
  "settings.permissions.tool.agent_send.description": "შეტყობინების გაგზავნა სხვა აგენტთან",
  "settings.permissions.tool.agent_stop.title": "აგენტის გაჩერება",
  "settings.permissions.tool.agent_stop.description": "ქვე-აგენტისა და მის ქვემოთ მყოფი აგენტების გაჩერება",
