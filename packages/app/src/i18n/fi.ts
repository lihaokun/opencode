export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agentti",
  "settings.permissions.tool.agent.description": "Käynnistä aliagentit",
  "settings.permissions.tool.agent_list.title": "Listaa agentit",
  "settings.permissions.tool.agent_list.description": "Listaa tämän istunnon agentit",
  "settings.permissions.tool.agent_send.title": "Lähetä viesti agentille",
  "settings.permissions.tool.agent_send.description": "Lähetä viesti toiselle agentille",
  "settings.permissions.tool.agent_stop.title": "Pysäytä agentti",
  "settings.permissions.tool.agent_stop.description": "Pysäytä aliagentti ja sen alaiset agentit",
