...
export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agentas",
  "settings.permissions.tool.agent.description": "Paleisti antrinius agentus",
  "settings.permissions.tool.agent_list.title": "Išvardyti agentus",
  "settings.permissions.tool.agent_list.description": "Išvardyti šios sesijos agentus",
  "settings.permissions.tool.agent_send.title": "Siųsti žinutę agentui",
  "settings.permissions.tool.agent_send.description": "Siųsti žinutę kitam agentui",
  "settings.permissions.tool.agent_stop.title": "Sustabdyti agentą",
  "settings.permissions.tool.agent_stop.description": "Sustabdyti antrinį agentą ir jam pavaldžius agentus",
