export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Start subagenten",
  "settings.permissions.tool.agent_list.title": "Agenten weergeven",
  "settings.permissions.tool.agent_list.description": "De agenten van deze sessie weergeven",
  "settings.permissions.tool.agent_send.title": "Bericht naar een agent sturen",
  "settings.permissions.tool.agent_send.description": "Een bericht naar een andere agent sturen",
  "settings.permissions.tool.agent_stop.title": "Een agent stoppen",
  "settings.permissions.tool.agent_stop.description": "Een subagent en de agenten daaronder stoppen",
