export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Зер-агентҳоро оғоз кунед",
  "settings.permissions.tool.agent_list.title": "Рӯйхати агентҳо",
  "settings.permissions.tool.agent_list.description": "Рӯйхати агентҳои ин ҷаласа",
  "settings.permissions.tool.agent_send.title": "Паём ба агент",
  "settings.permissions.tool.agent_send.description": "Фиристодани паём ба агенти дигар",
  "settings.permissions.tool.agent_stop.title": "Боздоштани агент",
  "settings.permissions.tool.agent_stop.description": "Боздоштани зер-агент ва агентҳои зери он",
