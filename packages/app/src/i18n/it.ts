export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Avvia subagenti",
  "settings.permissions.tool.agent_list.title": "Elenca agenti",
  "settings.permissions.tool.agent_list.description": "Elenca gli agenti di questa sessione",
  "settings.permissions.tool.agent_send.title": "Invia messaggio a un agente",
  "settings.permissions.tool.agent_send.description": "Invia un messaggio a un altro agente",
  "settings.permissions.tool.agent_stop.title": "Arresta un agente",
  "settings.permissions.tool.agent_stop.description": "Arresta un subagente e gli agenti sottostanti",
