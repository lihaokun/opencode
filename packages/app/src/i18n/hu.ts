...
export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Ügynök",
  "settings.permissions.tool.agent.description": "Al-ügynökök indítása",
  "settings.permissions.tool.agent_list.title": "Ügynökök listázása",
  "settings.permissions.tool.agent_list.description": "A munkamenet ügynökeinek listázása",
  "settings.permissions.tool.agent_send.title": "Üzenet küldése ügynöknek",
  "settings.permissions.tool.agent_send.description": "Üzenet küldése egy másik ügynöknek",
  "settings.permissions.tool.agent_stop.title": "Ügynök leállítása",
  "settings.permissions.tool.agent_stop.description": "Al-ügynök és az alatta lévő ügynökök leállítása",
