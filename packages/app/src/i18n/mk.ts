export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Стартувајте под-агенти",
  "settings.permissions.tool.agent_list.title": "Листа на агенти",
  "settings.permissions.tool.agent_list.description": "Листа на агентите во оваа сесија",
  "settings.permissions.tool.agent_send.title": "Порака до агент",
  "settings.permissions.tool.agent_send.description": "Испраќање порака до друг агент",
  "settings.permissions.tool.agent_stop.title": "Запирање агент",
  "settings.permissions.tool.agent_stop.description": "Запирање на под-агент и агентите под него",
