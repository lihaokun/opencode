export const dict = {
  ...
  "settings.permissions.tool.agent.title": "เอเจนต์",
  "settings.permissions.tool.agent.description": "เปิดเอเจนต์ย่อย",
  "settings.permissions.tool.agent_list.title": "แสดงรายการเอเจนต์",
  "settings.permissions.tool.agent_list.description": "แสดงรายการเอเจนต์ในเซสชันนี้",
  "settings.permissions.tool.agent_send.title": "ส่งข้อความถึงเอเจนต์",
  "settings.permissions.tool.agent_send.description": "ส่งข้อความถึงเอเจนต์อื่น",
  "settings.permissions.tool.agent_stop.title": "หยุดเอเจนต์",
  "settings.permissions.tool.agent_stop.description": "หยุดเอเจนต์ย่อยและเอเจนต์ที่อยู่ใต้มัน",
