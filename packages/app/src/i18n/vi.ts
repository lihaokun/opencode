export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Tác nhân",
  "settings.permissions.tool.agent.description": "Khởi chạy tác nhân phụ",
  "settings.permissions.tool.agent_list.title": "Liệt kê tác nhân",
  "settings.permissions.tool.agent_list.description": "Liệt kê các tác nhân trong phiên này",
  "settings.permissions.tool.agent_send.title": "Gửi tin nhắn cho tác nhân",
  "settings.permissions.tool.agent_send.description": "Gửi tin nhắn cho tác nhân khác",
  "settings.permissions.tool.agent_stop.title": "Dừng tác nhân",
  "settings.permissions.tool.agent_stop.description": "Dừng một tác nhân phụ và các tác nhân bên dưới nó",
