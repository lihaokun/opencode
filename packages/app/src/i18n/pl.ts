export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Uruchamianie podagentów",
  "settings.permissions.tool.agent_list.title": "Wyświetlanie agentów",
  "settings.permissions.tool.agent_list.description": "Wyświetlanie agentów w tej sesji",
  "settings.permissions.tool.agent_send.title": "Wiadomość do agenta",
  "settings.permissions.tool.agent_send.description": "Wysyłanie wiadomości do innego agenta",
  "settings.permissions.tool.agent_stop.title": "Zatrzymywanie agenta",
  "settings.permissions.tool.agent_stop.description": "Zatrzymywanie podagenta i agentów mu podległych",
