export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agen",
  "settings.permissions.tool.agent.description": "Luncurkan sub-agen",
  "settings.permissions.tool.agent_list.title": "Daftar agen",
  "settings.permissions.tool.agent_list.description": "Daftar agen dalam sesi ini",
  "settings.permissions.tool.agent_send.title": "Kirim pesan ke agen",
  "settings.permissions.tool.agent_send.description": "Kirim pesan ke agen lain",
  "settings.permissions.tool.agent_stop.title": "Hentikan agen",
  "settings.permissions.tool.agent_stop.description": "Hentikan sub-agen dan agen di bawahnya",
