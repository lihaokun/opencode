export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Spusťte dílčí agenty",
  "settings.permissions.tool.agent_list.title": "Vypsat agenty",
  "settings.permissions.tool.agent_list.description": "Vypsat agenty v této relaci",
  "settings.permissions.tool.agent_send.title": "Poslat zprávu agentovi",
  "settings.permissions.tool.agent_send.description": "Poslat zprávu jinému agentovi",
  "settings.permissions.tool.agent_stop.title": "Zastavit agenta",
  "settings.permissions.tool.agent_stop.description": "Zastavit dílčího agenta a agenty pod ním",
