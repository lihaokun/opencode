export const dict = {
  ...
  "settings.permissions.tool.agent_list.description": "Vis agenterne i denne session",
  "settings.permissions.tool.agent_send.title": "Send besked til agent",
  "settings.permissions.tool.agent_send.description": "Send en besked til en anden agent",
  "settings.permissions.tool.agent_stop.title": "Stop agent",
  "settings.permissions.tool.agent_stop.description": "Stop en underagent og agenterne under den",
