export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Sub-agentleri işe giriziň",
  "settings.permissions.tool.agent_list.title": "Agentleri sanamak",
  "settings.permissions.tool.agent_list.description": "Şu sessiýadaky agentleri sanamak",
  "settings.permissions.tool.agent_send.title": "Agente habar ibermek",
  "settings.permissions.tool.agent_send.description": "Başga bir agente habar ibermek",
  "settings.permissions.tool.agent_stop.title": "Agenti saklamak",
  "settings.permissions.tool.agent_stop.description": "Sub-agenti we onuň aşagyndaky agentleri saklamak",
