export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Alt agentləri işə sal",
  "settings.permissions.tool.agent_list.title": "Agentləri siyahıla",
  "settings.permissions.tool.agent_list.description": "Bu sessiyadakı agentləri siyahıla",
  "settings.permissions.tool.agent_send.title": "Agentə mesaj göndər",
  "settings.permissions.tool.agent_send.description": "Başqa bir agentə mesaj göndər",
  "settings.permissions.tool.agent_stop.title": "Agenti dayandır",
  "settings.permissions.tool.agent_stop.description": "Alt agenti və ondan asılı agentləri dayandır",
