export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agente",
  "settings.permissions.tool.agent.description": "Iniciar subagentes",
  "settings.permissions.tool.agent_list.title": "Listar agentes",
  "settings.permissions.tool.agent_list.description": "Listar los agentes de esta sesión",
  "settings.permissions.tool.agent_send.title": "Enviar mensaje a un agente",
  "settings.permissions.tool.agent_send.description": "Enviar un mensaje a otro agente",
  "settings.permissions.tool.agent_stop.title": "Detener un agente",
  "settings.permissions.tool.agent_stop.description": "Detener un subagente y los agentes que dependen de él",
