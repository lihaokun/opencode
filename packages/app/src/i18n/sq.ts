export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Agjent",
  "settings.permissions.tool.agent.description": "Nisni nën-agjentët",
  "settings.permissions.tool.agent_list.title": "Listo agjentët",
  "settings.permissions.tool.agent_list.description": "Listo agjentët e këtij sesioni",
  "settings.permissions.tool.agent_send.title": "Dërgo mesazh një agjenti",
  "settings.permissions.tool.agent_send.description": "Dërgo një mesazh një agjenti tjetër",
  "settings.permissions.tool.agent_stop.title": "Ndalo një agjent",
  "settings.permissions.tool.agent_stop.description": "Ndalo një nën-agjent dhe agjentët nën të",
