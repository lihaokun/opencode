export const dict: Record<string, string> = {
  ...
  "settings.permissions.tool.agent.title": "ལས་ཚབ།",
  "settings.permissions.tool.agent.description": "ཡན་ལག་ལས་ཚབ་ཚུ་འགོ་བཙུགས།",
  "settings.permissions.tool.agent_list.title": "ལས་ཚབ་ཚུ་ཐོ་བཀོད།",
  "settings.permissions.tool.agent_list.description": "ལཱ་ཐེངས་འདི་ནང་གི་ལས་ཚབ་ཚུ་ཐོ་བཀོད།",
  "settings.permissions.tool.agent_send.title": "ལས་ཚབ་ལུ་འཕྲིན་གཏང་།",
  "settings.permissions.tool.agent_send.description": "ལས་ཚབ་གཞན་ལུ་འཕྲིན་གཏང་།",
  "settings.permissions.tool.agent_stop.title": "ལས་ཚབ་བཀག་།",
  "settings.permissions.tool.agent_stop.description": "ཡན་ལག་ལས་ཚབ་དང་དེའི་འོག་གི་ལས་ཚབ་ཚུ་བཀག",
