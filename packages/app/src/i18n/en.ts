...
export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Launch sub-agents",
  "settings.permissions.tool.agent_list.title": "List agents",
  "settings.permissions.tool.agent_list.description": "List the agents in this session",
  "settings.permissions.tool.agent_send.title": "Message an agent",
  "settings.permissions.tool.agent_send.description": "Send a message to another agent",
  "settings.permissions.tool.agent_stop.title": "Stop an agent",
  "settings.permissions.tool.agent_stop.description": "Stop a subagent and the agents below it",
