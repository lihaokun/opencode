export const dict = {
  ...
  "settings.permissions.tool.agent_list.description": "Listar os agentes desta sessão",
  "settings.permissions.tool.agent_send.title": "Enviar mensagem a um agente",
  "settings.permissions.tool.agent_send.description": "Enviar uma mensagem a outro agente",
  "settings.permissions.tool.agent_stop.title": "Parar um agente",
  "settings.permissions.tool.agent_stop.description": "Parar um subagente e os agentes abaixo dele",
