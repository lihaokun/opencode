export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Գործակալ",
  "settings.permissions.tool.agent.description": "Ենթագործակալների գործարկում",
  "settings.permissions.tool.agent_list.title": "Ցուցակագրել գործակալներին",
  "settings.permissions.tool.agent_list.description": "Ցուցակագրել այս աշխատաշրջանի գործակալներին",
  "settings.permissions.tool.agent_send.title": "Հաղորդագրություն գործակալին",
  "settings.permissions.tool.agent_send.description": "Ուղարկել հաղորդագրություն այլ գործակալի",
  "settings.permissions.tool.agent_stop.title": "Կանգնեցնել գործակալին",
  "settings.permissions.tool.agent_stop.description": "Կանգնեցնել ենթագործակալին և նրա ներքևի գործակալներին",
