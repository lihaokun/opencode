export const dict = {
  ...
  "settings.permissions.tool.agent.title": "エージェント",
  "settings.permissions.tool.agent.description": "サブエージェントの起動",
  "settings.permissions.tool.agent_list.title": "エージェントの一覧",
  "settings.permissions.tool.agent_list.description": "このセッションのエージェントを一覧表示",
  "settings.permissions.tool.agent_send.title": "エージェントへのメッセージ送信",
  "settings.permissions.tool.agent_send.description": "別のエージェントにメッセージを送信",
  "settings.permissions.tool.agent_stop.title": "エージェントの停止",
  "settings.permissions.tool.agent_stop.description": "サブエージェントとその配下のエージェントを停止",
