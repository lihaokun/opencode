export const dict = {
  ...
  "settings.permissions.tool.agent.title": "에이전트",
  "settings.permissions.tool.agent.description": "하위 에이전트 실행",
  "settings.permissions.tool.agent_list.title": "에이전트 목록",
  "settings.permissions.tool.agent_list.description": "이 세션의 에이전트 목록 보기",
  "settings.permissions.tool.agent_send.title": "에이전트에 메시지 전송",
  "settings.permissions.tool.agent_send.description": "다른 에이전트에 메시지 보내기",
  "settings.permissions.tool.agent_stop.title": "에이전트 중지",
  "settings.permissions.tool.agent_stop.description": "하위 에이전트와 그 아래 에이전트 중지",
