...
export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Umboðsmaður",
  "settings.permissions.tool.agent.description": "Ræstu undir-umboðsmenn",
  "settings.permissions.tool.agent_list.title": "Telja upp umboðsmenn",
  "settings.permissions.tool.agent_list.description": "Telja upp umboðsmenn þessarar setu",
  "settings.permissions.tool.agent_send.title": "Senda skilaboð til umboðsmanns",
  "settings.permissions.tool.agent_send.description": "Senda skilaboð til annars umboðsmanns",
  "settings.permissions.tool.agent_stop.title": "Stöðva umboðsmann",
  "settings.permissions.tool.agent_stop.description": "Stöðva undir-umboðsmann og umboðsmenn undir honum",
