export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Πράκτορας",
  "settings.permissions.tool.agent.description": "Εκκίνηση υπο-πρακτόρων",
  "settings.permissions.tool.agent_list.title": "Λίστα πρακτόρων",
  "settings.permissions.tool.agent_list.description": "Λίστα των πρακτόρων αυτής της συνεδρίας",
  "settings.permissions.tool.agent_send.title": "Μήνυμα σε πράκτορα",
  "settings.permissions.tool.agent_send.description": "Αποστολή μηνύματος σε άλλον πράκτορα",
  "settings.permissions.tool.agent_stop.title": "Διακοπή πράκτορα",
  "settings.permissions.tool.agent_stop.description": "Διακοπή ενός υπο-πράκτορα και των πρακτόρων κάτω από αυτόν",
