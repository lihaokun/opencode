export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Ejen",
  "settings.permissions.tool.agent.description": "Lancarkan sub-ejen",
  "settings.permissions.tool.agent_list.title": "Senaraikan ejen",
  "settings.permissions.tool.agent_list.description": "Senaraikan ejen dalam sesi ini",
  "settings.permissions.tool.agent_send.title": "Hantar mesej kepada ejen",
  "settings.permissions.tool.agent_send.description": "Hantar mesej kepada ejen lain",
  "settings.permissions.tool.agent_stop.title": "Hentikan ejen",
  "settings.permissions.tool.agent_stop.description": "Hentikan sub-ejen dan ejen di bawahnya",
