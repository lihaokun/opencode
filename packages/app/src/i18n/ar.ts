export const dict = {
  ...
  "settings.permissions.tool.agent.title": "وكيل",
  "settings.permissions.tool.agent.description": "تشغيل الوكلاء الفرعيين",
  "settings.permissions.tool.agent_list.title": "سرد الوكلاء",
  "settings.permissions.tool.agent_list.description": "سرد الوكلاء في هذه الجلسة",
  "settings.permissions.tool.agent_send.title": "مراسلة وكيل",
  "settings.permissions.tool.agent_send.description": "إرسال رسالة إلى وكيل آخر",
  "settings.permissions.tool.agent_stop.title": "إيقاف وكيل",
  "settings.permissions.tool.agent_stop.description": "إيقاف وكيل فرعي والوكلاء التابعين له",
