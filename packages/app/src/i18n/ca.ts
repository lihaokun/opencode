export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Llançar subagents",
  "settings.permissions.tool.agent_list.title": "Llistar agents",
  "settings.permissions.tool.agent_list.description": "Llistar els agents d'aquesta sessió",
  "settings.permissions.tool.agent_send.title": "Enviar missatge a un agent",
  "settings.permissions.tool.agent_send.description": "Enviar un missatge a un altre agent",
  "settings.permissions.tool.agent_stop.title": "Aturar un agent",
  "settings.permissions.tool.agent_stop.description": "Aturar un subagent i els agents que en depenen",
