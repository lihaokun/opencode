export const dict = {
  ...
  "settings.permissions.tool.agent.title": "عامل",
  "settings.permissions.tool.agent.description": "عوامل فرعی را راه اندازی کنید",
  "settings.permissions.tool.agent_list.title": "فهرست عامل‌ها",
  "settings.permissions.tool.agent_list.description": "فهرست عامل‌های این نشست",
  "settings.permissions.tool.agent_send.title": "ارسال پیام به یک عامل",
  "settings.permissions.tool.agent_send.description": "ارسال پیام به عامل دیگر",
  "settings.permissions.tool.agent_stop.title": "توقف یک عامل",
  "settings.permissions.tool.agent_stop.description": "توقف یک عامل فرعی و عامل‌های زیرمجموعه آن",
