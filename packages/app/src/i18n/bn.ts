export const dict: Record<string, string> = {
  ...
  "settings.permissions.tool.agent.title": "এজেন্ট",
  "settings.permissions.tool.agent.description": "সাব-এজেন্ট চালু করুন",
  "settings.permissions.tool.agent_list.title": "এজেন্ট তালিকা",
  "settings.permissions.tool.agent_list.description": "এই সেশনের এজেন্টগুলির তালিকা",
  "settings.permissions.tool.agent_send.title": "এজেন্টকে বার্তা পাঠান",
  "settings.permissions.tool.agent_send.description": "অন্য একটি এজেন্টকে বার্তা পাঠান",
  "settings.permissions.tool.agent_stop.title": "এজেন্ট থামান",
  "settings.permissions.tool.agent_stop.description": "একটি সাব-এজেন্ট এবং তার অধীনস্থ এজেন্টগুলি থামান",
