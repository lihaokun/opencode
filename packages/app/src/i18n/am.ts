export const dict = {
  ...
  "settings.permissions.tool.agent.title": "ወኪል",
  "settings.permissions.tool.agent.description": "ንዑስ ወኪሎችን አስጀምር",
  "settings.permissions.tool.agent_list.title": "ወኪሎችን ዘርዝር",
  "settings.permissions.tool.agent_list.description": "በዚህ ክፍለ ጊዜ ያሉትን ወኪሎች ዘርዝር",
  "settings.permissions.tool.agent_send.title": "ለወኪል መልእክት ላክ",
  "settings.permissions.tool.agent_send.description": "ለሌላ ወኪል መልእክት ላክ",
  "settings.permissions.tool.agent_stop.title": "ወኪልን አቁም",
  "settings.permissions.tool.agent_stop.description": "ንዑስ ወኪልንና ከሱ በታች ያሉትን አቁም",
