...
export const dict = {
  ...
  "settings.permissions.tool.agent.title": "代理程式",
  "settings.permissions.tool.agent.description": "啟動子代理程式",
  "settings.permissions.tool.agent_list.title": "列出代理程式",
  "settings.permissions.tool.agent_list.description": "列出本工作階段中的代理程式",
  "settings.permissions.tool.agent_send.title": "向代理程式傳送訊息",
  "settings.permissions.tool.agent_send.description": "向另一個代理程式傳送訊息",
  "settings.permissions.tool.agent_stop.title": "停止代理程式",
  "settings.permissions.tool.agent_stop.description": "停止一個子代理程式及其下層代理程式",
