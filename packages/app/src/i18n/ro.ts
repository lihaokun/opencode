export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Pornește subagenți",
  "settings.permissions.tool.agent_list.title": "Listează agenții",
  "settings.permissions.tool.agent_list.description": "Listează agenții din această sesiune",
  "settings.permissions.tool.agent_send.title": "Trimite mesaj unui agent",
  "settings.permissions.tool.agent_send.description": "Trimite un mesaj altui agent",
  "settings.permissions.tool.agent_stop.title": "Oprește un agent",
  "settings.permissions.tool.agent_stop.description": "Oprește un subagent și agenții din subordinea lui",
