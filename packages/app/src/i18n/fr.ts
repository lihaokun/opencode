export const dict = {
  ...
  "settings.permissions.tool.agent.description": "Lancer des sous-agents",
  "settings.permissions.tool.agent_list.title": "Lister les agents",
  "settings.permissions.tool.agent_list.description": "Lister les agents de cette session",
  "settings.permissions.tool.agent_send.title": "Envoyer un message à un agent",
  "settings.permissions.tool.agent_send.description": "Envoyer un message à un autre agent",
  "settings.permissions.tool.agent_stop.title": "Arrêter un agent",
  "settings.permissions.tool.agent_stop.description": "Arrêter un sous-agent et les agents qui en dépendent",
