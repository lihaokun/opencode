...
export const dict = {
  ...
  "settings.permissions.tool.agent.title": "Ajan",
  "settings.permissions.tool.agent.description": "Alt ajanlar başlat",
  "settings.permissions.tool.agent_list.title": "Ajanları listele",
  "settings.permissions.tool.agent_list.description": "Bu oturumdaki ajanları listele",
  "settings.permissions.tool.agent_send.title": "Ajana mesaj gönder",
  "settings.permissions.tool.agent_send.description": "Başka bir ajana mesaj gönder",
  "settings.permissions.tool.agent_stop.title": "Ajanı durdur",
  "settings.permissions.tool.agent_stop.description": "Bir alt ajanı ve altındaki ajanları durdur",
