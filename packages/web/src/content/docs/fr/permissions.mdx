...
- `doom_loop` — déclenché lorsqu'une séquence identique d'appels d'outil de période 1 à 10 se répète 3 fois ; 3 appels consécutifs identiques constituent le cas de période 1
