...
- `doom_loop` — acionado quando uma sequência idêntica de chamadas de ferramenta com período de 1 a 10 se repete 3 vezes; 3 chamadas consecutivas idênticas são o caso de período 1
