...
- `doom_loop` — udløses, når en identisk sekvens af værktøjskald med periode 1 til 10 gentages 3 gange; 3 identiske på hinanden følgende kald er tilfældet med periode 1
