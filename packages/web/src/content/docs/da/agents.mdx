...
### Opgavetilladelser (`permission.agent`)

Kontroller, hvilke subagenter en agent kan påkalde via opgaveværktøjet med `permission.agent`. Bruger glob-mønstre til fleksibel matchning.
