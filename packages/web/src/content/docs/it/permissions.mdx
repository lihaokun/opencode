...
- `doom_loop` — si attiva quando una sequenza identica di chiamate a strumenti con periodo da 1 a 10 si ripete 3 volte; 3 chiamate consecutive identiche sono il caso di periodo 1
