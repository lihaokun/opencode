...
- `doom_loop` – wird ausgelöst, wenn sich eine identische Folge von Werkzeugaufrufen mit Periode 1 bis 10 dreimal wiederholt; drei identische aufeinanderfolgende Aufrufe sind der Fall mit Periode 1
