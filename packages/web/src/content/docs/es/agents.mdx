...
Controle qué subagentes puede invocar un agente a través de la herramienta Tarea con `permission.agent`. Utiliza patrones globales para una combinación flexible.
