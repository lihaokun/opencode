...
- `doom_loop`: se activa cuando una secuencia idéntica de llamadas de herramienta con período de 1 a 10 se repite 3 veces; 3 llamadas consecutivas idénticas son el caso de período 1
