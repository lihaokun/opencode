...
Kontroluj, których subagentów może wywołać ten agent za pomocą narzędzia zadania, używając `permission.agent`. Używa wzorców glob do elastycznego dopasowywania.
