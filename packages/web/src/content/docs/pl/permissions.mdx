...
- `doom_loop` — wyzwalane, gdy identyczna sekwencja wywołań narzędzi o okresie od 1 do 10 powtórzy się 3 razy; 3 identyczne kolejne wywołania to przypadek okresu 1
